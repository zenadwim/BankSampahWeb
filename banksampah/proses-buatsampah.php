...
if(isset($_POST['Input'])){
    ...
    // buat query
    $sql = "INSERT INTO sampah (id_sampah, nama_sampah, harga_pengepul, harga_nasabah, id_kategori) VALUE ('$id_sampah', '$nama_sampah', '$harga_pengepul', '$harga_nasabah', '$id_kategori')";
